...
from game_objects.cars import Car, GreenBigCar, GreenCar, PurpleCar, RedCar, YellowCar
import pygame
import os
...
class Gameplay(Scene):
    def __init__(self, game):
        ...
        self.car = YellowCar(self.tm)
        self.car.set_rotation(10)
    ...
    def update(self):
        self.car.update(dt=self.game.dt)
